...
\small\input{tabelas/interpolacao}
\end{table}
...
\label{tab:aumento}
\footnotesize\input{tabelas/aumento}
\end{table}
...
\small\input{tabelas/verificador}
\end{table}
